...
def test_4WL(k12, k21, k23, k32, k34, k43, k41, k14, k24, k42, SP4WL):
    ...
    for i in range(G4wl.number_of_nodes()):
        SP4WL_SymPy.append(
            state_prob_funcs4wl[i](k12, k21, k23, k32, k34, k43, k41, k14, k24, k42)
        )
...
def test_generate_flux_diags_4WL(k12, k21, k23, k32, k34, k43, k41, k14, k24, k42):
    ...
    G4wl = nx.MultiDiGraph()
    graph_utils.generate_edges(G4wl, k4wl)
    G4wl_cycles = graph_utils.find_all_unique_cycles(G4wl)
    flux_diags_G4wl = []
...
def test_calc_cycle_flux_3(k12, k21, k23, k32, k13, k31):
    ...
    G3 = nx.MultiDiGraph()
    graph_utils.generate_edges(G3, k3)
    G3_cycles = graph_utils.find_all_unique_cycles(G3)[0]
    cycle_order3 = [0, 1]
